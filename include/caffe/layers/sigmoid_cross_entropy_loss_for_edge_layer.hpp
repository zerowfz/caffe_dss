#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_FOR_EDGE_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_FOR_EDGE_LAYER_HPP_
...
class SigmoidCrossEntropyLossForEdgeLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossForEdgeLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyLossForEdge"; }
