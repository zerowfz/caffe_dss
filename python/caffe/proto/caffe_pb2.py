...
_SPP_SEGPARAMETER_POOLMETHOD = _descriptor.EnumDescriptor(
  name='PoolMethod',
  full_name='caffe.SPP_SEGParameter.PoolMethod',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_SPP_SEGPARAMETER_POOLMETHOD)

_SPP_SEGPARAMETER_ENGINE = _descriptor.EnumDescriptor(
  name='Engine',
  full_name='caffe.SPP_SEGParameter.Engine',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_SPP_SEGPARAMETER_ENGINE)
...
_SOLVERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sal_size', full_name='caffe.SolverParameter.sal_size', index=17,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='edge_size', full_name='caffe.SolverParameter.edge_size', index=18,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spp_seg_param', full_name='caffe.LayerParameter.spp_seg_param', index=56,
...
_SPP_SEGPARAMETER = _descriptor.Descriptor(
  name='SPP_SEGParameter',
  full_name='caffe.SPP_SEGParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pyramid_height', full_name='caffe.SPP_SEGParameter.pyramid_height', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pool', full_name='caffe.SPP_SEGParameter.pool', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.SPP_SEGParameter.weight_filler', index=2,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='engine', full_name='caffe.SPP_SEGParameter.engine', index=3,
      number=6, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _SPP_SEGPARAMETER_POOLMETHOD,
    _SPP_SEGPARAMETER_ENGINE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_LAYERPARAMETER.fields_by_name['spp_seg_param'].message_type = _SPP_SEGPARAMETER
...
_SPP_SEGPARAMETER.fields_by_name['pool'].enum_type = _SPP_SEGPARAMETER_POOLMETHOD
_SPP_SEGPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
_SPP_SEGPARAMETER.fields_by_name['engine'].enum_type = _SPP_SEGPARAMETER_ENGINE
_SPP_SEGPARAMETER_POOLMETHOD.containing_type = _SPP_SEGPARAMETER
_SPP_SEGPARAMETER_ENGINE.containing_type = _SPP_SEGPARAMETER
...
DESCRIPTOR.message_types_by_name['SPP_SEGParameter'] = _SPP_SEGPARAMETER
...
SPP_SEGParameter = _reflection.GeneratedProtocolMessageType('SPP_SEGParameter', (_message.Message,), dict(
  DESCRIPTOR = _SPP_SEGPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SPP_SEGParameter)
  ))
_sym_db.RegisterMessage(SPP_SEGParameter)
